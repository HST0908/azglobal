...
//Custom Code
require $theme_dir . '/functions/actions.php';
require $theme_dir . '/functions/filters.php';
require $theme_dir . '/functions/function.php';
require $theme_dir . '/functions/posttype.php';
require $theme_dir . '/functions/taxonomy.php';
require $theme_dir . '/functions/shortcodes.php';
require $theme_dir . '/functions/ajaxs.php';

<?php
/**
 * Template name: Quản lý xây dựng
 */
...
<div class="main_container">
            ...
            <div class="menu_top_drive">
                <div class="menu_top_drive-box">
                    <ul class="menu-top-list">
                        ...
                        <li class="menu-top-list-item"><a href="/quan-li-bat-dong-san/">Quản lý bất động sản</a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <section class="section">
        <div class="section-banner">
            <div class="img_wrap">
                <img src="/wp-content/uploads/2023/12/banner_qlxd.png" alt="">
            </div>
        </div>
    </section>
            ...
            <div class="introduce-real-estate">
                    ...
                    <div class="introduce-real-estate-left">
                        ...
                        <div class="flex_box jus_end introduce-service">
                            ...
                            <div class="service-right">
                                <div class="img_wrap">
                                    <img src="/wp-content/uploads/2023/12/qlxd1.png" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col_6 tablet_col_6 mobile_col_12">
                    <div class="introduce-real-estate-right">
                        <div class="img_wrap">
                            <img src="/wp-content/uploads/2023/12/qlxd2.png" alt="">
                        </div>
                        <div class="text_wrap">
                            <p>
                ...
                <div class="management-services-box">
                    <div class="content_wrap">
                        <div class="item-left col_6 tablet_col_6 mobile_col_12">
                            <div class="img_box">
                                <img src="/wp-content/uploads/2023/12/Rectangle-18016.png" alt="" cursorshover="true">
                            </div>
                            <div class="text_wrap">
                                <div class="title">
    ...
    <!-- Dự án đã thực hiện -->
    <section class="section implementation-project">
        <div class="grid-container">
            <div class="implementation-project_box">
                <h1 class="title">dự án az global đã thực hiện</h1>
                <div class="implementation-project_wrap">
                    <div class="item item-left col_6 tablet_col_6 mobile_col_12">
                        <div class="item-inner">
                            <div class="img_wrap">
                                <img src="/wp-content/uploads/2023/12/Rectangle-18111.png" alt="">
                            </div>
                            <div class="text_wrap">
                                <div class="title">Dự án 1</div>
                                <p class="limit_line limit_4">
                                Tọa lạc giữa trung tâm thành phố Budapest, tòa nhà Felsőerdősor 8 được AZ Global thi công cải tạo trong vòng 1 năm. Tòa nhà gồm 3 tầng ở 1 tầng hầm ,12 căn hộ studio được thiết kế theo phong cách hiện đại cùng với hệ thống trang thiết bị tân tiến.
                                </p>
                            </div>
                        </div>
                        
                            
                        <div class="img_wrap img-bot">
                            <img src="/wp-content/uploads/2023/12/Rectangle-18112.png" alt="">
                        </div>

                        <div class="btn btn-primary text_uppercase">
                            Đăng ký tư vấn
                        </div>
                    </div>
                    
                    <div class="item item-right col_6 tablet_col_6 mobile_col_12">
                        <div class="item-inner">
                            <div class="item_1">
                                <div class="img_wrap">
                                    <img src="/wp-content/uploads/2023/12/Rectangle-18114.png" alt="">
                                </div>
                                <div class="text_wrap">
                                    <h1 class="title">Dự án 3</h1>
                                    <p>
                                    Bên cạnh các dự án, AZ Global đã cải tạo trên 30 căn hộ thô với phong cách tiết kế cá nhân hóa theo ý muốn của nhà đầu tư.
                                    </p>
                                </div>
                            </div>
                            <div class="item_2">
                                <div class="text_wrap">
                                    <h1 class="title">Dự án 2</h1>
                                    <p>
                                    Hiện tại công ty cũng sở hữu những quỹ dự án tại Hungary, nổi bật nhất là dự án tại Bajnok, trung tâm của Budapest, Hungary - một biểu tượng mới của kiến trúc hiện đại và cuộc sống đô thị cao cấp.
                                    Với sự hợp tác của các kiến trúc sư hàng đầu, dự án không chỉ mang tính thẩm mỹ cao mà còn tập trung vào việc gìn giữ những nét đặc trưng của Hungary.
                                    Mỗi căn hộ tại đây đều được thiết kế tỉ mỉ để tối ưu hóa không gian sống và mang lại trải nghiệm sống đẳng cấp.
                                    Cư dân sẽ được tận hưởng các tiện ích cao cấp như phòng gym hiện đại, sân thượng với tầm nhìn toàn thành phố và khu vực tiếp khách sang trọng.
                                    Vị Trí Đắc Địa: Nằm tại vị trí trung tâm của Bajnok, Budapest, dự án thuận tiện cho việc di chuyển và gần gũi với các tiện ích xung quanh như nhà hàng, cửa hàng, và các điểm vui chơi giải trí.
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="faq-box">
                    <div class="faq-item active">
                        <div class="faq-item-title flex_box jus_between al_center">
                            <span class="title">
                            AZ Global thi công trong những lĩnh vực gì?
                            </span>
                        ...
                        <div class="faq-item-content">
                            <p>
                            AZ Global hoạt động trong nhiều lĩnh vực để đáp ứng mọi nhu cầu xây dựng và cải tạo của bạn: 1.Thi công và quản lí xây dựng các dự án bất động sản dân cư và thương mại 2.Cải tạo và trang trí nội thất căn hộ: Biến các căn hộ thành không gian sống hiện đại, tiện nghi và phù hợp với nhu cầu của gia chủ
                            </p>
                        </div>
                    </div>
                    <div class="faq-item">
                        <div class="faq-item-title flex_box jus_between al_center">
                            <span class="title">
                            Thời gian cải tạo căn hộ trong bao lâu?
                            </span>
                            <div class="button_icon">
                                <img src="/wp-content/uploads/2023/12/Group-19424.svg" alt="">
                                <img src="/wp-content/uploads/2023/12/Group-19403.svg" alt="">
